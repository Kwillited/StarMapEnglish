...
<template>
  ...
  <div class="space-y-4">
    <!-- 页面标题 -->
    <div class="space-y-1">
      <h2 class="text-xl font-bold text-white">信号截获 (Listening)</h2>
      <p class="text-slate-400 text-sm">BBC News / 2023真题</p>
    </div>
    ...
    <div class="glass-card p-4 rounded-xl">
      <!-- 听力文本 -->
      <div class="mb-4">
        <h3 class="text-base font-bold text-white mb-2">新闻文本</h3>
        <div class="space-y-2">
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
              ...
              <input 
                ...
                v-model="volume" 
                @input="adjustVolume" 
                class="w-20 h-1 bg-slate-700 rounded-full appearance-none cursor-pointer accent-listen"
              />
            </div>
          </div>
        </div>
    ...
    <!-- 听力练习题目 -->
    <div class="glass-card p-4 rounded-xl">
      <h3 class="text-lg font-bold text-white mb-3">听力理解题</h3>
