...
const currentWords = computed(() => {
  return wordStore.studyMode === 'test' ? wordStore.filteredWords : wordStore.filteredWords;
});
  ...
  <div class="space-y-4">
    ...
    <div class="p-4 mb-4">
      ...
      <div class="flex items-center justify-between mb-3">
        ...
        <h3 class="text-lg font-semibold text-white">词汇测试</h3>
